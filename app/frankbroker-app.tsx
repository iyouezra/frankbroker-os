...
export default function FrankBrokerApp({ userName }: { userName: string }) {
  ...
  const runValidation = () => {
    ...
    const owned = client.accountId === "acc_meron" && instrument.symbol === "WGBX" ? 2000 : client.accountId === "acc_blue" && instrument.symbol === "WGBX" ? 5200 : 0;
    const results = [
