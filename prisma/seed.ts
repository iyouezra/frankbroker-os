...
async function main() {
  ...
  await prisma.user.createMany({
    data: [
      ...
      { id: "usr_finance", brokerId: "brk_abyssinia", employeeId: "ABS-0092", email: "tigist@frankbroker.et", fullName: "Tigist Bekele", jobTitle: "Financial Controller", department: "Finance", role: "finance", status: "active" },
