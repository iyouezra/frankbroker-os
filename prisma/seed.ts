...
async function main() {
  ...
  await prisma.user.createMany({
    data: [
      ...
      { id: "usr_blue_tenant_admin", brokerId: "brk_blue_nile", employeeId: "BNC-0002", email: "tenant.admin@bluenile.example", fullName: "Mimi Solomon", jobTitle: "Tenant Administrator", department: "Operations", role: "broker_admin", status: "active", mfaEnabled: true },
