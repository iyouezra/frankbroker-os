...
async function main() {
  ...
  const tenantSettings = [
    { id: "set_brk_abyssinia", brokerId: "brk_abyssinia", tradingName: "Abyssinia Securities", plan: "Enterprise", domain: "invest.abyssinia.et", supportEmail: "support@abyssinia.example", primaryColor: "#0C8189", welcomeMessage: "Access Ethiopian shares and government bonds through one simple platform.", businessDate: dateOnly("2026-07-14"), features: { investorPortal: true, selfDirected: true, bonds: true, recurringInvestments: true, institutionalAccounts: true, manualTradeCapture: true, riskComplianceMonitoring: false }, makerChecker: true, approvalThreshold: 250_000, clientDailyLimit: 2_500_000, brokerageFeePct: .5, minimumFee: 25, settlementCycle: "T+2", allowedOrderTypes: ["Market", "Limit", "Stop-loss"], requireTermsAcceptance: true, discrepancyWindowDays: 10, kycReviewMonths: 12 },
    { id: "set_brk_blue_nile", brokerId: "brk_blue_nile", tradingName: "Addis Capital", plan: "Growth", domain: "invest.addiscapital.example", supportEmail: "care@addiscapital.example", primaryColor: "#2277C8", welcomeMessage: "A simpler way to own ESX companies and government bonds.", businessDate: dateOnly("2026-07-14"), features: { investorPortal: true, selfDirected: true, bonds: true, recurringInvestments: false, institutionalAccounts: true, manualTradeCapture: true, riskComplianceMonitoring: false }, makerChecker: true, approvalThreshold: 100_000, clientDailyLimit: 750_000, brokerageFeePct: .65, minimumFee: 30, settlementCycle: "T+2", allowedOrderTypes: ["Market", "Limit"], requireTermsAcceptance: true, discrepancyWindowDays: 10, kycReviewMonths: 12 },
    { id: "set_brk_sheba", brokerId: "brk_sheba", tradingName: "Sheba Advisory", plan: "Pilot", domain: "sheba.frankbroker.demo", supportEmail: "advisory@sheba.example", primaryColor: "#0E9F5B", welcomeMessage: "Manage Ethiopian issuer readiness with clear ownership and evidence.", businessDate: dateOnly("2026-07-14"), features: { investorPortal: false, selfDirected: false, bonds: false, recurringInvestments: false, institutionalAccounts: false, manualTradeCapture: false, riskComplianceMonitoring: false }, makerChecker: true, approvalThreshold: 50_000, clientDailyLimit: 250_000, brokerageFeePct: .75, minimumFee: 35, settlementCycle: "T+2", allowedOrderTypes: ["Limit"], requireTermsAcceptance: true, discrepancyWindowDays: 10, kycReviewMonths: 12 },
  ];
