...
VALUES (
  'platform_fees_1_1', 'ESX market and regulatory fees', '1.1', 'published', DATE '2026-08-04', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
)
...
VALUES
  ('platform_fee_1_1_equity_main', 'platform_fees_1_1', 'equity', 'main', 0.15, 0.36, 0.02),
  ('platform_fee_1_1_bond_main', 'platform_fees_1_1', 'bond', 'main', 0.005, 0.021, 0.02)
