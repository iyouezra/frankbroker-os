...
export function Dashboard({ orders, auditEntries, queue, settlementCycle, manualTradeCapture, onViewOrders, onNewOrder, onSettle, onOpenWork }: { orders: DemoOrder[]; auditEntries: AuditEntry[]; queue: WorkItem[]; settlementCycle: string; manualTradeCapture: boolean; onViewOrders: () => void; onNewOrder: () => void; onSettle: () => void; onOpenWork: (item: WorkItem) => void }) {
