...
export type TenantApiResult = { tenant?: { id?: string; tradingName?: string; licenseNumber?: string; primaryColor?: string; features?: Partial<TenantFeatures>; modules?: Partial<TenantModules>; profile?: { businessType?: string } | null; availableRoles?: Role[]; currentRole?: Role; controls?: Partial<TenantControls> | null }; instruments?: TenantApiInstrument[] };
