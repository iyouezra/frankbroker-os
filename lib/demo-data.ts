...
export type DemoOrder = {
  ...
  contractNoteGeneratedAt?: string;
  ...
  ledgerEntries?: Array<{
    id: string;
    ledger: "cash" | "securities";
    entryType: string;
    amount?: number;
    quantity?: number;
    totalImpact: number;
    availableImpact: number;
    blockedImpact: number;
    unsettledImpact: number;
...
export const demoClients = [
  ...
  { id: "cli_blue", accountId: "acc_blue", code: "CL-10017", name: "Blue Nile Trading PLC", type: "Corporate", kyc: "Approved", status: "Active", cash: 2_196_568.75, available: 1_611_568.75, blocked: 585_000, risk: "Standard", holdings: "5 positions" },
...
export const initialOrders: DemoOrder[] = [
  { id: "ORD-2026-1048", time: "10:42", createdAt: "2026-07-14T10:42:00Z", client: "Wegagen Pension Fund", clientCode: "CL-10008", accountId: "acc_wegagen", instrumentId: "ins_tele", symbol: "TELE", side: "buy", quantity: 7000, price: 312.5, orderType: "Limit", estimatedGross: 2187500, estimatedFees: 10937.5, estimatedNet: 2198437.5, status: "pending_broker_review", source: "Manual", trader: "Dawit A.", riskFlag: "review", filledQuantity: 0, remainingQuantity: 7000, blockedCash: 2198437.5 },
  { id: "ORD-2026-1047", time: "10:19", createdAt: "2026-07-14T10:19:00Z", client: "Meron Bekele", clientCode: "CL-10041", accountId: "acc_meron", instrumentId: "ins_wgbx", symbol: "WGBX", side: "sell", quantity: 1200, price: 1735, orderType: "Limit", estimatedGross: 2082000, estimatedFees: 10410, estimatedNet: 2071590, status: "approved", source: "Manual", trader: "Dawit A.", riskFlag: "review", filledQuantity: 0, remainingQuantity: 1200, blockedQuantity: 1200 },
  { id: "ORD-2026-1046", time: "09:54", createdAt: "2026-07-14T09:54:00Z", client: "Blue Nile Trading PLC", clientCode: "CL-10017", accountId: "acc_blue", instrumentId: "ins_goeb_2029", symbol: "GB2029", side: "buy", quantity: 25000, price: 99.85, orderType: "Limit", estimatedGross: 2496250, estimatedFees: 12481.25, estimatedNet: 2508731.25, status: "settlement_pending", source: "Manual", trader: "Hana K.", riskFlag: "review", settlementDate: "2026-07-16", tradeId: "TRD-2026-0772", filledQuantity: 25000, remainingQuantity: 0, averageFillPrice: 99.85, executedGross: 2496250, executedFees: 12481.25, executedNet: 2508731.25, blockedCash: 0 },
  { id: "ORD-2026-1045", time: "09:31", createdAt: "2026-07-14T09:31:00Z", client: "Meron Bekele", clientCode: "CL-10041", accountId: "acc_meron", instrumentId: "ins_goeb_2031", symbol: "GB2031", side: "buy", quantity: 3000, price: 100.6, orderType: "Limit", estimatedGross: 301800, estimatedFees: 1509, estimatedNet: 303309, status: "settled", source: "Manual", trader: "Hana K.", riskFlag: "none", settlementDate: "2026-07-14", tradeId: "TRD-2026-0768", filledQuantity: 3000, remainingQuantity: 0, averageFillPrice: 100.6, executedGross: 301800, executedFees: 1509, executedNet: 303309 },
